...
function circCentral(dRad, rad, which, offset){
    ...
    this.draw = function() {
        ...
        grad.addColorStop(0, 'rgba(50, 50, 50, '+ this.alpha +')')
        grad.addColorStop(1, 'rgba(150, 150, 250, 0.00)')
        ...
        gra.addColorStop(0, 'rgba(50, 50, 50, '+ this.alpha +')')
        gra.addColorStop(1, 'rgba(150, 150, 250, 0.00)')
...
function bulle(x, y, dx, dy, dRad, rad, max ){
    ...
    this.draw = function() {
        ...
        grad.addColorStop(0, 'rgba(0, 0, 20, '+this.alpha / 2+')')
